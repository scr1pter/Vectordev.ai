export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Vector",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Vector has been downloaded, would you like to install it and relaunch?",
