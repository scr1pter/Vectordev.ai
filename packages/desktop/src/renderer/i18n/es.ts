export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Vector",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Vector. ¿Quieres instalarla y reiniciar?",
