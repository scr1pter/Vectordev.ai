...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with Vector's review experience (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
