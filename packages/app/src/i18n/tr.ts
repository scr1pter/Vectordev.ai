...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Vector tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Vector'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vector Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Vector'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Vector'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler vector.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Vector sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Vector'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Vector ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (vector.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Vector henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "app.name.desktop": "Vector Masaüstü",
  ...
  "settings.desktop.wsl.description": "Vector sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Vector'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Vector'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Vector'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Vector'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Vector başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Vector'un en son sürümünü kullanıyorsunuz.",
