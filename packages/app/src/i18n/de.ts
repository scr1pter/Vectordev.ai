...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Vector zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Vector zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Vector zu nutzen.",
  ...
  "dialog.plugins.empty": "In vector.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Vector-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Vector ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Vector-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (vector.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Vector unterstützt noch keine MCP-Authentifizierung.',
  ...
  "session.followupDock.copy": "Kopieren",
  ...
  "settings.desktop.wsl.description": "Vector-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Vector ändern",
  ...
  "settings.updates.row.startup.description": "Beim Start von Vector automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Vector.",
