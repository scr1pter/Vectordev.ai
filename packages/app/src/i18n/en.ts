export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Vector",
  ...
  "provider.connect.opencodeZen.line1":
    "Vector Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Vector does not support MCP authentication yet.',
