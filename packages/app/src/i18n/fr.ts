export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Vector.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Vector.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Vector.",
  ...
  "prompt.action.queue": "Mettre en file",
  ...
  "dialog.plugins.empty": "Plugins configurés dans vector.json",
  ...
  "dialog.server.description": "Changez le serveur Vector auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Vector ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Vector",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (vector.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Vector ne supporte pas encore l'authentification MCP.",
  ...
  "session.followupDock.copy": "Copier",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Vector dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Vector",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Vector sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Vector suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Vector.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Vector",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Vector.",
