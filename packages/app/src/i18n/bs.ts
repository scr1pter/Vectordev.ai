export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Vector",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Vector-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vector Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Vector-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Vector-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u vector.json",
  ...
  "dialog.server.description": "Promijeni na koji se Vector server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Vector-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Vector timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (vector.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Vector još ne podržava MCP autentifikaciju.',
  ...
  "session.followupDock.copy": "Kopiraj",
  "session.followupDock.delete": "Obriši",
  ...
  "settings.desktop.wsl.description": "Pokreni Vector server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Vector-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Vector izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Vector prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Vector-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Vector pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Vector-a.",
