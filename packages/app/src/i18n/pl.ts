export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Vector.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Vector.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Vector.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w vector.json",
  ...
  "dialog.server.description": "Przełącz serwer Vector, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Vector ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Vector",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (vector.json) nazwy dostawców/modeli",
  ...
  "session.followupDock.copy": "Kopiuj",
  "session.followupDock.delete": "Usuń",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Vector",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Vector na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Vector ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Vector.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Vector",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Vector.",
