...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Vector.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Vector.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Vector.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i vector.json",
  ...
  "dialog.server.description": "Bytt hvilken Vector-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Vector ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Vector-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (vector.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Vector ikke støtter MCP-autentisering ennå.',
  ...
  "session.followupDock.copy": "Kopier",
  "session.followupDock.delete": "Slett",
  ...
  "settings.desktop.wsl.description": "Kjør Vector-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Vector",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Vector ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Vector skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Vector er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Vector starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Vector.",
