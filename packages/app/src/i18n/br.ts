export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Vector",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Vector.",
  ...
  "provider.connect.opencodeZen.line1":
    "Vector Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Vector.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Vector.",
  ...
  "prompt.action.queue": "Enfileirar",
  ...
  "dialog.plugins.empty": "Plugins configurados em vector.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Vector este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Vector ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Vector",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (vector.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Vector ainda não suporta autenticação MCP.',
  ...
  "session.followupDock.delete": "Excluir",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Vector dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Vector",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Vector aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Vector segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Vector é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Vector iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Vector.",
