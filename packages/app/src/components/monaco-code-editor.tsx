...
function ensureMonacoEnvironment() {
  ...
  monaco.editor.defineTheme("vector-dark", {
    base: "vs-dark",
    inherit: true,
    // Vector neon — deep violet ground with glowing purple/orchid/aqua tokens,
    // matching the workspace's aurora language instead of stock VS Code grey.
    rules: [
    ...
    colors: {
      ...
      "editor.foreground": "#e6ddff",
      "editorGutter.background": "#140f1e",
      "editorLineNumber.foreground": "#5d4f85",
      "editorLineNumber.activeForeground": "#c9b0ff",
      "editor.lineHighlightBackground": "#1e1533",
      "editor.lineHighlightBorder": "#00000000",
      "editor.selectionBackground": "#4b2f8f80",
      "editor.inactiveSelectionBackground": "#35265e59",
      "editor.selectionHighlightBackground": "#3c2a7350",
      "editorCursor.foreground": "#c9b0ff",
      "editorIndentGuide.background1": "#2b2144",
      "editorIndentGuide.activeBackground1": "#6a4fc0",
      "editorWhitespace.foreground": "#2b2144",
      "editorWidget.background": "#1a1329",
      "editorWidget.border": "#3c2d66",
      "editorHoverWidget.background": "#1a1329",
      "editorHoverWidget.border": "#3c2d66",
      "editorSuggestWidget.background": "#1a1329",
      "editorSuggestWidget.border": "#3c2d66",
      "editorSuggestWidget.selectedBackground": "#2c2050",
      "editorGhostText.foreground": "#6a5a95",
      "editorBracketMatch.background": "#00000000",
      "editorBracketMatch.border": "#7c5ce6",
      "minimap.background": "#140f1e",
      "editorStickyScroll.background": "#140f1e",
      "editorStickyScrollHover.background": "#1e1533",
      "editorOverviewRuler.border": "#00000000",
      "scrollbarSlider.background": "#7c5ce633",
      "scrollbarSlider.hoverBackground": "#7c5ce655",
      "scrollbarSlider.activeBackground": "#7c5ce677",
    },
  })
}
