...
const GLOBAL_STORAGE = "vector.global.dat"
const WINDOW_STORAGE = "vector.window"
const LOCAL_PREFIX = "vector."
...
function workspaceStorage(dir: string) {
  ...
  return `vector.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `vector.draft.${head}.${sum}.dat`
}
