...
export const TOUR_SLIDES: TourSlide[] = [
  {
    ...
    body: "Choose the codebase you want to build. Vector keeps the chat, files, Browser, Terminal, usage, and every agent attached to that project.",
  },
  {
    route: "/",
    eyebrow: "Build your way",
    titlePre: "Write it yourself.",
    titleEm: "Or delegate.",
    body: "Open Code editor when you want to work directly, or give the main Vector agent one clear result. You can move between manual coding and agent work without leaving the project.",
  },
  {
    route: "/",
    eyebrow: "Run and inspect",
    titlePre: "Use Terminal.",
    titleEm: "See Browser.",
    body: "Terminal runs commands in the active project. Browser shows the real app beside the chat, and the agent can navigate that same visible page to test flows, inspect failures, repair code, and retest.",
  },
  {
    route: "/",
    eyebrow: "Work in parallel",
    titlePre: "Add agents.",
    titleEm: "Avoid collisions.",
    body: "Create another workspace when work can happen in parallel. Each agent gets an isolated worktree, chat, files, and terminal, so frontend, backend, auth, or testing can progress at the same time.",
  },
  {
    route: "/",
    ...
    titlePre: "Review.",
    titleEm: "Then merge.",
    body: "Inspect every diff and check result before merging isolated work back into the main project. Publish through Vector Cloud only when the project is ready.",
  },
]
