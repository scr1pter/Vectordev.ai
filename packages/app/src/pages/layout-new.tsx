  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Show when={leftSidebarOpen()} fallback={<img src="/vector-logo.png" alt="" class="size-5 rounded-md" />}>
        ...
        <div class="mt-5 flex flex-1 flex-col items-center gap-2">
          ...
          >
            <svg viewBox="0 0 16 16" class="size-4" aria-hidden="true">
              <path
                d="M2.75 5.5h10.5v7H2.75zM2.75 5.5l1.6-2h3.2l1.2 2"
                fill="none"
                stroke="currentColor"
                stroke-width="1.35"
          ...
          >
            <svg viewBox="0 0 16 16" class="size-4" aria-hidden="true">
              <path
                d="M3.5 5.5h9M3.5 10.5h9M6 3.5v4M10 8.5v4"
                fill="none"
                stroke="currentColor"
                stroke-width="1.35"
                stroke-linecap="round"
        ...
        <div class="flex flex-col items-center gap-2">
          ...
          >
            ...
            >
              <svg viewBox="0 0 16 16" class="size-4" aria-hidden="true">
                <path
                  d="M8 2.25v1.5m0 8.5v1.5M3.93 3.93l1.06 1.06m6.02 6.02 1.06 1.06M2.25 8h1.5m8.5 0h1.5M3.93 12.07l1.06-1.06m6.02-6.02 1.06-1.06M8 5.15a2.85 2.85 0 1 1 0 5.7 2.85 2.85 0 0 1 0-5.7Z"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.25"
                  stroke-linecap="round"
          ...
          >
            <svg viewBox="0 0 16 16" class="size-4" aria-hidden="true">
              <path
                d="M8 5.25a2.75 2.75 0 1 1 0 5.5 2.75 2.75 0 0 1 0-5.5Zm0-3v1.5m0 8.5v1.5M3.93 3.93l1.06 1.06m6.02 6.02 1.06 1.06m1.68-4.07h-1.5m-8.5 0h-1.5m1.68 4.07 1.06-1.06m6.02-6.02 1.06-1.06"
                fill="none"
                stroke="currentColor"
                stroke-width="1.25"
                stroke-linecap="round"
          ...
          >
            <svg viewBox="0 0 16 16" class="size-4" aria-hidden="true">
              <path
                d="M8 14a6 6 0 1 0 0-12 6 6 0 0 0 0 12Zm0-3.5v.1M6.35 6.25a1.72 1.72 0 0 1 1.72-1.5c1.02 0 1.78.63 1.78 1.55 0 1.45-1.85 1.37-1.85 2.7"
                fill="none"
                stroke="currentColor"
                stroke-width="1.35"
                stroke-linecap="round"
        ...
        <div class="flex h-full flex-col">
          ...
          <div class="min-h-0 flex-1 space-y-2 overflow-y-auto p-3">
            ...
            >
              ...
              <svg viewBox="0 0 16 16" class="size-4 text-white/42" aria-hidden="true">
                <path
                  d="M3 12.5V8m3.3 4.5v-8m3.4 8v-5m3.3 5v-10"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
      ...
      >
        <div class="flex h-full flex-col">
          <div class="flex items-center justify-between border-b border-[#2a2a2d] px-4 py-3">
            <div>
              <div class="text-sm font-semibold text-white">Web preview</div>
              <div class="mt-0.5 text-xs text-white/42">Open a local app beside Vector.</div>
            </div>
            <button
              type="button"
